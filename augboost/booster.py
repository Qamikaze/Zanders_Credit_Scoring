...
model = ABC(n_estimators=20, max_epochs=100, learning_rate=0.1, verbose = 2,\
    n_features_per_subset=3, trees_between_feature_update=10, max_depth = 5,\
    augmentation_method='pca', save_mid_experiment_accuracy_results=False, loss='deviance',
      )
