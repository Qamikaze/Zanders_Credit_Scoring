...
- **Models**: this section contains all the used models.
  ...
  - **LogisticRegression**: This file is used to perform the Weight of Evidence on the data and subsequently perform the logistic regression and get its output.
